% 9/18/2021 -  derived from hacking_2021_06_02and09and23and30_and07_14and21
...
% For a single ”week” on a single Tower
% Train on ALL of the week (all preforms) together, all ‘good’ subbatches within
%
% example pdf in rev7_newtest51_DrawData_Tower51_2021-01-05_to2021-01-12__filter1_ERR_TrALL.pdf
%
% load rev7_newtest51_DrawData_Tower51_2020-12-22_to2020-12-29__filter1.mat
...
% % Train on each (here only one) week separately, 
% % Eval: Compare the avg / std for prediction from each week-model on other week
% %
% % example pdf in rev7_newtest51_DrawData_Tower51_2021-01-05_to2021-01-12__filter1_ERR_TrALLvsALL.pdf
% %
% %load rev7_newtest51_DrawData_Tower51_2020-12-22_to2020-12-29__filter1.mat
% load rev7_newtest51_DrawData_Tower51_2021-01-05_to2021-01-12__filter1.mat
% trainedNetworkModel_ARRAY = [];
...
%     load rev6_temp10_newtest48_maxEpochs250_mx8000_drop200_lstm350lstm0_filter1.mat
%     trainedNetworkModel_ARRAY = [];
%     matfilename ='rev7_DrawData_Tower48_2021-03-16_to2021-03-23__trALL_maxE250_mx8000_drop200_lstm100lstm50_filter1.mat'  %these are misnamed,  are 350
%     tmpP = stlload_trainedNetworkModel_ARRAY_fromfile(matfilename);
%     trainedNetworkModel_ARRAY{1} = tmpP{1};
%     matfilename ='rev7_DrawData_Tower48_2020-12-08_to2020-12-15__trALL_maxE250_mx8000_drop200_lstm100lstm50_filter1.mat' %these are misnamed,  are 350
%     tmpP = stlload_trainedNetworkModel_ARRAY_fromfile(matfilename);
%     trainedNetworkModel_ARRAY{2} = tmpP{1};
%     bPlotAllFreqOverride = 1;
% end
...
% trainedNetworkModel_ARRAY = [];
% ssLoad = load('rev7_DrawData_Tower48_2021-03-16_to2021-03-23__trALL_maxE250_mx8000_drop200_lstm350lstm0_filter1.mat','XTrainTRANSPOSE_ARRAY', 'YTrainTRANSPOSE_ARRAY');
% XTrainTRANSPOSE_ARRAY = ssLoad.XTrainTRANSPOSE_ARRAY;
% YTrainTRANSPOSE_ARRAY = ssLoad.YTrainTRANSPOSE_ARRAY;
% 
% ssLoad = load('rev7_DrawData_Tower48_2021-03-16_to2021-03-23__trALL_maxE250_mx8000_drop200_lstm350lstm0_filter1.mat','trainedNetworkModel_ARRAY');
% trainedNetworkModel_ARRAY{1} = ssLoad.trainedNetworkModel_ARRAY{1};
% ssLoad = load('rev7_DrawData_Tower48_2020-12-08_to2020-12-15__trALL_maxE250_mx8000_drop200_lstm350lstm0_filter1.mat','trainedNetworkModel_ARRAY');
% trainedNetworkModel_ARRAY{2} = ssLoad.trainedNetworkModel_ARRAY{1};
% bPlotAllFreqOverride = 1;
        ...
        for nWhichSub = 1:nsubs
            ...
            if(1) %plotting
                ...
                for i2 = 1:1
                    ...
                    %new figure for each Bach2Test   
                    myfigNUMBER = nWhichBatch2Test*10000;
                    myfigHANDLE = figure(myfigNUMBER);
                    
                    mysubfigHANDLE0 = subplot(4,nsubs,nWhichSub);
            ...
            end %end of if plotting

        end %end of subbatch loop
        
        %save figure for each batch and close it
        %str4Fig = ['fig' num2str(nWhichBatch2Test*10000) '.fig'];
        %savefig(myfigHANDLE,str4Fig);
       
        %func_tightsubplotreorg(myfigHANDLE,4, nsubs);
        
        myfigHANDLEarray{nWhichBatch2Test} = myfigHANDLE;
        myfigNUMBERarray(nWhichBatch2Test) = myfigNUMBER;
        myfigSUBPLOTarray(:,nWhichBatch2Test) = [4 nsubs];
        
        str4Fig = ['testsavefig' num2str(nWhichBatch2Test*10000) '.mat'];
        %save(str4Fig,'myfigHANDLE');
%        close(myfigHANDLE);

%         savefig(mysubfigHANDLE0,'foo.fig');
%         mynewfig = figure(9876);
%         copyobj(allchild(mysubfigHANDLE0),mynewfig)       
...
for nWhichBatch2Test        = nWhichBatch2Test_array
    ...
    myfigNUMBER = nWhichBatch2Test*1000000;
    myfigHANDLE = figure(myfigNUMBER);
    ...
    curlen = length(myfigHANDLEarray);
    myfigHANDLEarray{curlen+1} = myfigHANDLE;
    myfigNUMBERarray(curlen+1) = myfigNUMBER;
    myfigSUBPLOTarray(:,curlen+1) = [2 1];
        
        
    %%
    
    myfigNUMBER = nWhichBatch2Test*1000001;
    myfigHANDLE = figure(myfigNUMBER);
    ...
    myfigHANDLEarray{curlen+1} = myfigHANDLE;
    myfigNUMBERarray(curlen+1) = myfigNUMBER;
    myfigSUBPLOTarray(:,curlen+1) = [1 1];
